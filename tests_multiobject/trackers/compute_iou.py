...
def get_nth_mask(gt_folder_name, n):
    file_path = os.path.join("/datagrid/personal/rozumrus/BP_dg/vot22ST/sequences", gt_folder_name, 'groundtruth.txt')  
    file_path_img = os.path.join("/datagrid/personal/rozumrus/BP_dg/vot22ST/sequences", gt_folder_name, 'color/00000001.jpg')
