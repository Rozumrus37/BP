...
class SAM2VideoPredictor(SAM2Base):
    ...
    def add_new_points_or_box(
        ...
        obj_idx = self._obj_id_to_idx(inference_state, obj_id) # maps object's id to some internal enumaration
        ...
        current_out, _, ious_output = self._run_single_frame_inference(
    ...
    def propagate_in_video(
        ...
        for frame_idx in tqdm(processing_order, desc="propagate in video"):
            ...
            yield frame_idx, obj_ids, video_res_masks, iou_output_scores_RR_added
    ...
    def _run_single_frame_inference(
        ...
        # print("OBJPTR shape is: ", obj_ptr.shape)
        ...
        return compact_current_out, pred_masks_gpu, current_out['ious_output']
